...
//        }
        {
            ...
            if (1
//                    pEvent->deviceInfo.dataLen > 10
//            &&     pEvent->deviceInfo.pEvtData[2]  == 0x66
...
//                {
//                    uart0_send(pEvent->deviceInfo.pEvtData[i],1);
//                }
                uint16_t len=0;
                grep_data(pEvent->deviceInfo.pEvtData, pEvent->deviceInfo.dataLen,
...
//                }
//                PRINT("\n");
//                PRINT("%x ", pEvent->deviceInfo.addrType);
//                PRINT("\n");
//            }
        }
        break;
